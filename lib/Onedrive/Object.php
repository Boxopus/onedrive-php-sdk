...
abstract class Object
{
     ...
     *
     * @param (Client) $client
     *            - The Client instance owning this Object instance.
     * @param (null|string) $id
     *            - The unique ID of the OneDrive object referenced
     *            by this Object instance.
     * @param (array|object) $options
     *            - An array/object with one or more of the
    ...
    public function fetchProperties()
    {
        ...
        $this->_parentId = '' != $result->parent_id ? (string) $result->parent_id : null;
        
        $this->_name = $result->name;
        
        $this->_description = '' != $result->description ? (string) $result->description : null;
